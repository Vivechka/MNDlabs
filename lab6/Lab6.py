...
for i in range(100):
    while True:
        ...
        def f123(X1, X2, X3):
            return 0.7 + 5.4*X1 + 4.8*X2 + 5.3*X3 + 1.1*X1*X1 + 0.3*X2*X2 + 8.9*X3*X3 + 8.1*X1*X2 + 0.2*X1*X3 + 3.5*X2*X3 + 1.9*X1*X2*X3 + random.randint(0, 10) - 5
        ...
        # print("\nРівняння регресії:")
        # print("y = {} + {} * X1 + {} * X2 + {} * X3 + {} * Х1X2 + \n  + {} * Х1X3 + {} * Х2X3 + {} * Х1Х2X3 + {} * X11^2 + {} * X22^2 + {} * X33^2"
...
print("кількість не значимих коефіцієнтів ", count)            
